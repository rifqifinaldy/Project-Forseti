...
const Motto = styled(motion.h2)`
  font-weight: 400;
  text-shadow: 0 0 21px #317481, 0 0 100px #317481;
`;
    ...
    return (
      <HeroSection>
        <HeroWrapper>
          <HeroSlide>
            <HeroSlider>
              <HeroText variants={sentence} initial="hidden" animate="visible">
        ...
        <Wave>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path
              fill="#010606"
              fillOpacity="0.6"
              d="M0,128L60,149.3C120,171,240,213,360,208C480,203,600,149,720,154.7C840,160,960,224,1080,250.7C1200,277,1320,267,1380,261.3L1440,256L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
            ></path>
          </svg>
        </Wave>
      </HeroSection>
